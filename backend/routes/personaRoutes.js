...
router.post('/insertar-proveedor', verifyToken, checkRole(['Encargado']),validatePersona, insertarProveedor);

// Ruta para insertar un comprador (un Empleado puede hacerlo)
router.post('/insertar-comprador', verifyToken, checkRole(['Empleado']),validatePersona, insertarComprador);
