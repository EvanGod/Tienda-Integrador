  ...
  <div class="container mt-5">
    ...
    <form id="form-proveedor" class="mt-4">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          <label for="tipo_documento" class="form-label">Tipo de Usuario</label>
...
<script>
  ...
  if (submitButton) {
    submitButton.addEventListener('click', () => {
      ...
      const rol = document.getElementById('id_rol').value.trim();
...
.then(data => {
    if (data.success) {
        ...
        const errorMessage = data.message || 'Hubo un error al registrar el usuario. Intenta nuevamente.';
