...
<script>
  ...
  const fecha = document.getElementById('fecha').value;  // Obtén la fecha seleccionada
  ...
  // Enviar la fecha al backend para obtener las ventas
  fetch('http://localhost:5000/api/ventas/ventas/por-dia/' + fecha, {
    method: 'GET',
    headers: {
